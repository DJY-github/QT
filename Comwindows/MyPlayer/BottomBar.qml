...
Rectangle{
    ...
    Row{
        ...
        Rectangle{
            ...
            MouseArea{
                ...
                hoverEnabled: true;
                onClicked: {
                    if(mediaPlayer.playbackState > 0)
                        mediaPlayer.playMusic(-1);
                }
            }
        }
    ...
    Text{
        ...
        width: 30;
        clip: true;
        text: calTime(mediaPlayer.position);
    }
    ...
    Text{
        ...
        text: calTime(mediaPlayer.duration);
        clip: true;
    }
    ...
    Row{
        ...
        Slider{
            ...
            MouseArea{
                ...
                acceptedButtons: Qt.LeftButton;
                onClicked: {
                    mediaPlayer.volume = mouse.x / parent.width;
                }
                onWheel: wheel.accepted = true;
    ...
    Row{
        ...
        Rectangle{
            ...
            Text{
                ...
                text: mediaPlayer.musicManager.musicCount;
                z: 1;
            }
        }
    }
