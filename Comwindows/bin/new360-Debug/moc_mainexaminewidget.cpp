...
#include "../../Qt360-10.0/src/main/bottom/mainexaminewidget.h"
...
const QMetaObject MainExamineWidget::staticMetaObject = {
...
void *MainExamineWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MainExamineWidget.stringdata0))
        return static_cast<void*>(const_cast< MainExamineWidget*>(this));
