...
QT_MOC_LITERAL(1, 7, 10), // "UpdateData"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "myWave\0UpdateData\0"
};
...
void myWave::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        myWave *_t = static_cast<myWave *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject myWave::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_myWave.data,
      qt_meta_data_myWave,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *myWave::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_myWave.stringdata0))
        return static_cast<void*>(const_cast< myWave*>(this));
