...
void GaugeClock::setSecondStyle(const GaugeClock::SecondStyle &secondStyle)
{
...
void GaugeClock::setSystemDateTime(const QString &year, const QString &month, const QString &day,
